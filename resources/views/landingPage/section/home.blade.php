...
@section('content')
    ...
    {{-- <------------------- About Us --------------------> --}}
    <<<<<<< HEAD <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        >>>>>>> 71e80ce328c77a5083fe72d28681675e72428801
        <div class="bg-primary justify-center items-center text-center pt-24 pb-48">
            <div class="wave-headerr">
                ...
                <p class="text-md mt-8 mb-12">Aplikasi Nusantara Inovasi is dedicated to building software solutions that
                    drive
        ...
        <<<<<<< HEAD <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            ...
            <div class=" justify-center items-center  text-center py-24 ">
                <div class="wave-headerr">
                    ...
                    <p class="text-md mt-8 mb-20 font-normal text-darkui">Our team of skilled professionals is dedicated to
                        delivering
                        high-quality
                ...
                <div class="flex flex-col md:flex-row justify-center mx-auto gap-4 mb-24 px-20 ">
                    ...
                    <div class="md:w-1/4 w-full max-w-sm bg-bgui border border-primary rounded-lg shadow py-24 text-center">
                        ...
                        <p class="mt-2 text-darkui">Our team of designers is <br> dedicated to creating intuitive <br> and
                            visually appealing
                    ...
                    <div class="md:w-1/4 w-full max-w-sm bg-bgui border border-primary rounded-lg shadow py-24 text-center">
                        ...
                        <p class="mt-2 text-darkui">Help you unlock the potential of <br>your data, providing valuable <br>
                            insights and
            ...
            <div class=" pt-24 pb-48 bg-tcolor2">
                <div class=" wave-headerr justify-center text-center">
                    ...
                    <p class="text-md mt-8 mb-20 font-normal text-darkui">We are incredibly excited to introduce our
                        <br>latest product, a
            ...
            <div class=" py-24">
                ...
                <div class="flex items-center justify-between p-8  ">
                    ...
                    <div class="md:w-1/2 md:mr-2 text-left md:px-24 w-full">
                        ...
                        <h1 class="text-left text-6xl text-tcolor1 font-semibold"><span
                                class="text-primary2">F</span>requently <br> <span class="text-primary2">A</span>sked
                            <br><span class="text-primary2">Q</span>uestions</h1>
                        <div class="mt-12">
                    ...
                    <div class="md:flex hidden md:w-1/2 md:mr-5">
                        <div class="md:w-1/2 w-full flex flex-col p-5">
                            <div class="flex flex-col">
                                <div
                                    class="border-tcolor1 border-2 bg-white p-2 mb-2 rounded-md flex flex-row justify-between">
                                ...
                                <div class="border-tcolor1 border-2 bg-white p-2 mb-2 rounded-md flex hidden">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui alias, hic repellendus
                                        aliquid nulla ducimus voluptates. Ratione nobis, officia sapiente reprehenderit
                                        voluptatibus quaerat reiciendis illo, earum, eveniet aspernatur laboriosam deserunt
                                        et quia atque dolorem voluptate enim repellat totam incidunt. Repellat.</p>
                                </div>
                            </div>
                            <div class="flex flex-col">
                                <div
                                    class="border-tcolor1 border-2 bg-primary2 p-2 mb-2 rounded-md flex flex-row justify-between">
                                    <h3>What type of development service do you offer ?</h3>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div class="py-24">
                <div class="wave-headewr justify-center text-center">
                    ...
                    <p class="text-md mt-8 mb-20 font-normal text-darkui">we take pride in delivering exceptional software
                        solutions that
                        exceed
                    ...
                    <div
                        ...
                        <div class="flex flex-col items-center pb-10 pt-10">
                            <img class="w-24 h-24 mb-3 rounded-full shadow-lg"
                                src="{{ asset('images/testi-image1.jpg') }}" alt="Bonnie image" />
