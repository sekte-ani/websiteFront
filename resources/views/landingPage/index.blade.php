...
<body>
        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ANI</span>
                </a>
                ...
                <div class="hidden w-full md:block md:w-auto " id="navbar-default">
                    <ul
                        ...
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Testimonials</a>
                        </li>
                        <li>
                            <button type="button"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-1 py-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Contact
                                Us</button>
                        </li>
    ...
    <script>
        function toggleText(answerId, questionId) {
            var x = document.getElementById(answerId);
            var y = document.getElementById(questionId);
            if (x.style.display === "none") {
                x.style.display = "flex";
                x.style.backgroundColor = "lightblue";
                y.classList.add("text-color2"); // Add color to the question
            } else {
                x.style.display = "none";
                y.classList.remove("text-color2"); // Remove color from the question
            }
        }
    </script>
    </script>
